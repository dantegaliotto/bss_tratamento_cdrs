-- ATENÇÃO: A QUERY DENTRO DO MAX DEVE ESTAR IGUAL A QUERY DO LOAD DOS PLANOS, 
-- SÓ NÃO INCLUIR OS PLANOS NIVEL CONTA NA VERIFICAÇÃO DAS DATAS
select max(dt_ativacao) max_dt_ativacao from (
select distinct 
